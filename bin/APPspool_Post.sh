...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/fnd_concurrent_queues.out
...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/fnd_profile_option_values.out
...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/workflow_mailer_status.out
...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/workflow_component_value.out
col VALUE for a40
...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/workflow_count.out
select count(*) WF_NOTIFICATIONS from apps.wf_notifications;
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/workflow_system_admin_value.out
select text from apps.wf_resources where name='WF_ADMIN_ROLE';
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/fnd_conc_req_value.out
select count(*) FND_CONCURRENT_REQUESTS from applsys.fnd_concurrent_requests;
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/fnd_logins.out
select count(*) FND_LOGINS from applsys.fnd_logins;
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/global_name.out
col GLOBAL_NAME for a15
select PROPERTY_VALUE GLOBAL_NAME from database_properties where PROPERTY_NAME like '%GLOBAL%';
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/email_status_0.out
...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/db_links.out
...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/msc_apps_instances.out
...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/profile_option_prod.out
@/ots/scripts/clone_sanity/profile_option_prod.sql
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/conc_manager_processes.out
@/ots/scripts/clone_sanity/manager_status.sql
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/conc_mngr_PSnodes.out
@/ots/scripts/clone_sanity/manager_nodes.sql
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/XDO_config_table.out
select VALUE from xdo_config_values where value like '%tmp%';
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/site_name.out
select profile_option_value from fnd_profile_option_values where lower(profile_option_value) like '%clone%';
spool off;

spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/patch_context_file.out
col NAME for a25 
col VERSION for a25 
col PATH for a130 
...
spool /ots/clone_patch/AUTO_TEST/validation/Inst_Details/$INSTNAME/post/vertex_setup_check.out
